...
var url = "mongodb+srv://socketuas:WRpsB5YKxeggX5u6@uas-socket-kahootclone.g9ewst9.mongodb.net/?retryWrites=true&w=majority";
...
(async () => {
    ...
    io.on('connection', (socket) => {    
        ...
        socket.on('host-join', (data) =>{
            ...
            dbo.collection('kahootGames').find(query).toArray()
                .then(result => {    
        ...
        socket.on('requestDbNames', function(){
                ...
                var dbo = client.db('kahootDB');
                dbo.collection("kahootGames").find().toArray()
                    .then(res => {
        ...
        socket.on('newQuiz', function(data){
                ...
                dbo.collection('kahootGames').find({}).toArray()
                    .then(result => {
                        ...
                        var game = data;
                        dbo.collection("kahootGames").insertOne(game)
                            .catch(err => {
                                throw err;
                            });
